...
#Since the p-value is less than alpha value 0.05, we reject the null hypothesis as there is proof that there is a statistical difference
...
# Since the p-value (Sig. (2-tailed) < 0.05, we reject the Null hypothesis and conclude that there exists a relationship between proportion of non-retail business acres per town and Nitric oxide concentration
